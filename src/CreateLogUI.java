...
public class CreateLogUI{
	...
	{
		this.client = client;
		//allEmployees = client.getAllEmployees().getEmployees();
		//userChatLogs = client.getEmployeeChatLogList().getChatLogs();
	   ...
	   button.addActionListener(new ActionListener()
	   {
	     public void actionPerformed(ActionEvent e)
	     {
	        if(!rightusers.isEmpty())
	        {
	        	...
	        	System.out.println();
	        	System.out.println();
	        	System.out.println(client.getEmployeeLoggedIn().getUsername());
	        	System.out.println("USERNAME ABOVE ME");
	        	System.out.println();
	        	System.out.println();
	        	System.out.println();
	        	System.out.println();
