...
public class ChatService implements Serializable{
	...
	private static EmployeeList allEmployees;
	private static ChatLogList allChatLogs;
	...
	//SETTERS
  	private void setEmployeeLoggedIn(Employee employeeLoggedIn){
    ...
    public Message getNewMessage(String chatLogName) {
    	int numOfMessages = ChatService.allChatLogs.get(chatLogName).getMessages().size();
    	return ChatService.allChatLogs.get(chatLogName).getMessages().get(numOfMessages-1);
    }
	...
	public void loadChatService(){
        ...
        allEmployees.add(new Employee("jo","12", true));
        allEmployees.add(new Employee("ky","34", false));
        allEmployees.add(new Employee("lu","56", false));
        allEmployees.add(new Employee("ty","78", false));

		// CHATLOGS
		this.setAllChatLogs(new ChatLogList());
		this.setEmployeeLoggedIn(new Employee());
        Vector<String> members1 = new Vector<String>();
        members1.add("jo");
        members1.add("ky");
        allChatLogs.add(new ChatLog("jo,ky", members1));

        Vector<String> members2 = new Vector<String>();
        members2.add("ty");
        members2.add("lu");
        allChatLogs.add(new ChatLog("ty,lu",members2));
			...
			while(scanner2.hasNextLine()) {
				String data2 = scanner2.nextLine();
						...
						while(scanner3.hasNextLine()) {
							...
							chatlog.addMessage(new Message (str3[0],str3[1]));
